 ...
 */
class Tech_Blog_Model_Resource_Post extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('tech_blog/post', 'entity_id');
    }
    ...
    public function lookupStoreIds($postId)
    {
        ...
        $select  = $adapter->select()
            ->from($this->getTable('tech_blog/post_store'), 'store_id')
     ...
     * @return Tech_Blog_Model_Resource_Post
     * @author Ultimate Module Creator
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Tech_Blog_Model_Post $object
    ...
    protected function _getLoadSelect($field, $value, $object)
    {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('blog_post_store' => $this->getTable('tech_blog/post_store')),
                $this->getMainTable() . '.entity_id = blog_post_store.post_id',
                array()
            )
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $table  = $this->getTable('tech_blog/post_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store)
    {
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('tech_blog/post_store')),
                'e.entity_id = es.post_id',
                array())
