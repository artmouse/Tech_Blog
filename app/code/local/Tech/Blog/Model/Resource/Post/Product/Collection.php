 ...
 */
class Tech_Blog_Model_Resource_Post_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('tech_blog/post_product')),
