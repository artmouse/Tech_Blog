...
/**
 * post - categories relation edit block
 *
 * @category    Tech
 * @package     Tech_Blog
 * @author      Ultimate Module Creator
 */
class Tech_Blog_Block_Adminhtml_Post_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
     ...
     * Returns root node
     *
     * @param Tech_Blog_Model_Category|null $parentNodeCategory
